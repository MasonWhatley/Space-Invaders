...
public class Display extends JFrame { //JFrame means "window", in effect
	...
	public static final Color [][] SHIP_SHAPE = 
		{
			{null,null,null, null, null, red, red, red, red, red, null, null, null, null,null, null, null, null, null},
			{null,null,null, null, red, red, red, red, red, red, red, red, red, null},
			{null,null,null, null, green, green, green, yellow, yellow, green, yellow, null, null, null},
			{null,null,null, green, yellow, green, yellow, yellow, yellow, green, yellow, yellow, yellow, null},
			{null,null,null, green, yellow, green, green, yellow, yellow, yellow, 	green, yellow, yellow, yellow},
			{null,null,null, green, green, yellow, yellow, yellow, yellow, green, green, green, green, null},
			{null,null,null, null, null, yellow, yellow, yellow, yellow, yellow, yellow, yellow, null, null, null, null},
			{null, null, green,green,green,green,green, red, red, green, green,},
			{yellow, yellow, yellow, green,green,green,green,red, red, red, green,green,green, yellow, yellow, yellow},
			{yellow, yellow, yellow, yellow, green, green, green, red, yellow, red, red, red, green, green, yellow, yellow},
			{yellow, yellow, yellow, null, red, red, red, red, red, red, red, red, red, yellow, yellow},
			{null, null, null, red, red, red, red, red, red, red, red, red, red, green, green},
			{null, null, red, red, red, red, red, red, red, red, red, red, red, green, green},
			{null, green, green, green, red, red, red, null, null, red, red, red, red, green, green},
			{null, green, green, green, green},
			{null, null, green, green, green, green}
	...
	public Display(int wide, int high) {
		...
		myApp = new SpaceInvaders(high, wide); //Set up the user's app
		setVisible(true);
	...
	public void draw() {
		if (myGraphics!=null) {
			...
			else
			{
				...
				for(Sprite item : myApp.getItems() ) {
					drawItem(item);
				}
			}
		}
